		...
		?>			
					...
					<div class="mt-5 border rounded">   
									...
									<div class="row">
										...
										<div class="col-4">
											<form action="delete.php" method="GET" >
												<input type="" name="idd" class="d-none" value="<?php echo $stroka["id"] ?>">
												<button class="btn-danger btn" style="margin-left: 100px;"><i class="fa fa-trash" aria-hidden="true"></i></button>
											</form>	
										</div>
									</div>
						...
						<div class="col-12 py-2">  <!--текстовые элементы поста-->
							...
							<form action="update.php" method="GET" class="form1" style="display: none;">
					 			<input type="" name="id" class="form-control" placeholder="id" value="<?php echo $stroka["id"] ?>">
					 			<input type="" name="text" class="form-control" placeholder="text" value="<?php echo $stroka["text"] ?>">
					 			<input type="" name="img" class="form-control" placeholder="img" value="<?php echo $stroka["img"] ?>">
					 			<button class="btn btn-success"><i class="fa fa-check-square" aria-hidden="true"></i></button>
	 						</form>	
	 						<button class="btn btn-primary btn1"><i class="fa fa-pencil-square" aria-hidden="true"></i></button>						
						</div> 
					</div>
				<!-- ПОСТ ЗАКРЫЛСЯ-->
				<?php }; ?> 
